...
function listarAlunosAprovados() {
    ...
    for (let i = 0; i < chamadaDeAlunos.length; i++) {
        ...
        for (let j = 0; j < chamadaDeAlunos[i].materias[j].length; j++) {
            
            if (chamadaDeAlunos[i].materias[j].nota >= 6) {
...
function listarAlunos() {
    ...
    for (let i = 0; i < chamadaDeAlunos.length; i++) {
        ...
        console.log(i + ') ' + "NOME: " + chamadaDeAlunos[i].nome + " | N° DE CHAMADA:" + chamadaDeAlunos[i].numeroChamada)
        
    }
    
}

function buscarAlunoPeloNumeroDaChamada(){

    for (let i = 0; i < chamadaDeAlunos.length; i++) {
        
        const busca = 1223
        
        if (chamadaDeAlunos[i].numeroChamada === busca) {
            
            console.log(chamadaDeAlunos[i].nome)
...
buscarAlunoPeloNumeroDaChamada()
listarAlunos()
